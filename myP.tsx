  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        {/* Account */}
        <div className="rounded-2xl border-t-4 border-t-amber-500 border-2 border-amber-500/30 bg-white p-5 shadow-sm flex flex-col">
          <div className="text-[10px] font-bold text-amber-600 uppercase tracking-wider mb-2">Standard Object + Usage Hierarchy</div>
          <h3 className="text-xl font-bold text-amber-600 mb-2">Account</h3>
          <div className="text-xs text-slate-500 font-mono mb-4 leading-relaxed">
            Account → Asset Line Items (Apttus CPQ) → <strong className="text-amber-600">child usage objects</strong>
          </div>

          <div className="space-y-3 mb-4">
            <div className="flex justify-between text-sm pb-2 border-b border-slate-100">
              <span className="text-slate-600 font-medium">Account_ID</span>
              <span className="text-amber-600 font-mono font-bold">ACC-00391</span>
            </div>
            <div className="flex justify-between text-sm pb-2 border-b border-slate-100">
              <span className="text-slate-600 font-medium">Active_Licenses</span>
              <span className="text-slate-900 font-mono">1,250</span>
            </div>
            <div className="flex justify-between text-sm pt-1">
              <span className="text-amber-600 font-medium">Usage_Score</span>
              <span className="text-amber-600 font-mono font-bold">Low (12%)</span>
            </div>
          </div>
          
          <div className="flex gap-2 flex-1 mt-auto">
            {/* What we know */}
            <div className="flex-1 p-2.5 rounded-lg bg-[#2e844a]/5 border border-[#2e844a]/20">
              <div className="text-[9px] font-bold text-[#2e844a] uppercase tracking-wider mb-2">What We Know</div>
              <ul className="text-[10px] text-slate-600 space-y-1.5 font-mono leading-relaxed">
                <li className="flex gap-1.5"><span className="text-slate-400">•</span><span>Assets = products purchased</span></li>
                <li className="flex gap-1.5"><span className="text-slate-400">•</span><span>Usage tracked as child objects</span></li>
                <li className="flex gap-1.5"><span className="text-slate-400">•</span><span>Data in Snowflake already</span></li>
              </ul>
            </div>
            
            {/* What we need to discover */}
            <div className="flex-1 p-2.5 rounded-lg bg-amber-50 border border-amber-200">
              <div className="text-[9px] font-bold text-amber-600 uppercase tracking-wider mb-2">To Discover (Day 1)</div>
              <ul className="text-[10px] text-slate-600 space-y-1.5 font-mono leading-relaxed">
                <li className="flex gap-1.5"><span className="text-slate-400">•</span><span>Exact usage object name + fields</span></li>
                <li className="flex gap-1.5"><span className="text-slate-400">•</span><span>Capture cadence (daily/weekly?)</span></li>
                <li className="flex gap-1.5"><span className="text-slate-400">•</span><span>Composite score in Snowflake?</span></li>
              </ul>
            </div>
          </div>
        </div>
...
function ArchitectureSlide() {
  return (
    <div className="space-y-4 animate-in fade-in duration-700">
      ...
      <div className="p-5 rounded-xl bg-slate-50 border-2 border-slate-200 flex items-center justify-between">
        <div className="flex flex-col items-start">
          <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-2">Output: One Enriched Fact Table</div>
          <div className="font-mono text-lg font-bold text-[#2e844a] px-4 py-2 rounded-lg bg-[#2e844a]/10">
            competitive_deal_outcomes
          </div>
        </div>
        <div className="flex gap-2 flex-wrap justify-end max-w-[70%]">
          {[
            ...
            <span key={tag.label} className="px-3 py-1.5 rounded-lg font-mono text-xs font-semibold border-2" style={{ 
    ...
    <div className="space-y-7 animate-in fade-in duration-700">
      ...
      <div className="p-6 rounded-xl bg-[#2e844a]/5 border-2 border-[#2e844a]/30">
        ...
        <div className="flex gap-3 flex-wrap items-center">
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-semibold bg-[#7c3aed]/15 border-2 border-[#7c3aed]/30 text-[#7c3aed]">Leading: Rival Analytics Co.</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-semibold bg-[#0176d3]/15 border-2 border-[#0176d3]/30 text-[#0176d3]">$84,000</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-semibold bg-[#0176d3]/15 border-2 border-[#0176d3]/30 text-[#0176d3]">Close: Nov 15</span>
          <span className="text-slate-400 font-bold">+</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-semibold bg-amber-100 border-2 border-amber-300 text-amber-700">Usage @ Close: 18%</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-semibold bg-amber-100 border-2 border-amber-300 text-amber-700">MAU: 3 of 50</span>
          <span className="text-slate-400 font-bold">=</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-bold bg-red-100 border-2 border-red-300 text-red-700">Tier: LOW</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-bold bg-red-100 border-2 border-red-300 text-red-700">Risk: TRUE</span>
          <span className="px-4 py-2 rounded-lg font-mono text-xs font-bold bg-red-100 border-2 border-red-300 text-red-700">Trend: ↘ declining</span>
        </div>
      </div>
    </div>
  );
